            ...
            <div class="box_story">
                ...
                <ul class="box_list">
                    <li><a href="view_post_regina.php">
                        ...
                        <div class="box_txt">
                            <dl class="txt">
                                ...
                                <dd>ビーバースレジーナエスピーアイ：キュアシリーズはきれいで細かく洗練されたナノスピキュールのみを使用したホームケアデイリー製品です。</dd>
                            </dl>
                            <div class="util en">
                    ...
                    <li><a href="view_post_patch.php">
                        ...
                        <div class="box_txt">
                            <dl class="txt">
                                <dt>ゴルフを愛するあなたに！太陽から守り抜く！</dt>
                                <dd>両面ファブリック UVカット特殊生地を使用、肌保湿、老化防止、肌の再生力を改善するパッチ</dd>
                            </dl>
                            <div class="util en">
                ...
                <ul class="pnav">
                    <li class="btn_prev"><a href="#123"><i class="fas fa-angle-left"></i></a></li>
                    <li class="active"><a href="#123">1</a></li>
                    <li><a href="#123">2</a></li>
                    <li><a href="#123">3</a></li>
                    <li><a href="#123">4</a></li>
                    <li><a href="#123">5</a></li>
                    <li class="btn_next"><a href="#123"><i class="fas fa-angle-right"></i></a></li>
                </ul>
            </div>
        </div>        
    </div>
