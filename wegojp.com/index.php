    ...
    <div id="con_page">
        ...
        <section class="con_story">
            ...
            <article class="box_story">
                <div class="box_list">
                    <div class="card"><a href="./story/view_post_tokyo.php">
                        <p class="img"><img src="./imgs/img_thum_tokyo.jpg" alt=""></p>
                        <dl>
                            <dt>東京ビッグサイト にて開催された「国際化粧品展」参加</dt>
                            <dd>先日、東京ビッグサイト にて開催された日本最大級の 国際化粧品展 に参加させて頂きました。</dd>
                        </dl>
                    </a></div>
                    <div class="card"><a href="./story/view_post_osaka.php">
                        <p class="img"><img src="../imgs/img_thum_osaka.jpg" alt=""></p>
                        <dl>
                            <dt>西日本最大級の「国際化粧品展」参加</dt>
                            <dd>大阪で西日本最大級の化粧品専門展「第2回 国際 化粧品展［大阪］ -COSME OSAKA 2021-」を開催しました。</dd>
                        </dl>
                    </a></div>
        ...
        <section class="con_biz">
            ...
            <article class="box_biz">
                <div class="biz_card"><a href="./business/#oem">
                    ...
                    <dl>
                        <dt>
                            <strong class="en">COSMETICS</strong>
                ...
                <div class="biz_card"><a href="./business/#ebiz">
                    ...
                    <dl>
                        ...
                        <dd>専門的な知識がなくてもオンラインビジネスを運営<br class="view_pc-tab">できるよう支援しています。</dd>
                    </dl>
                </a></div>
                <div class="biz_card"><a href="./business/#consulting">
                    ...
                    <dl>
                        ...
                        <dd>私たちはクライアントの成功的な成長のために様々な<br class="view_pc-tab">分野の専門家による相談を支援しています。</dd>
                    </dl>
                </a></div>
            </article>
